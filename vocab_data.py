# from vocab import vocab_list  # Assuming vocab_list is defined in the 'vocab' module
import json
vocab_list = {
    '1': {'word': 'aberration',
    ...
    '36': {'word': 'abate',
           ...
           'keywords': ['subside', 'lessen', 'diminish', 'decline', 'fade', 'dwindle', 'slaken']},
    '37': {'word': '',
           'meaning': '',
           'example': '',
           'keywords': ['too great', 'extreme', 'expressed', 'described in words', 'beauty', 'sunset', 'ocean', 'onlookers', 'speechless']}}
...
with open("vocab_data.json", "w") as json_file:
    json.dump(vocab_list, json_file, indent=4)
